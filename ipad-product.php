                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="image/ipad-1.jpg" class="recent-thumb" alt="">
                            <h2><a href="#">Asus  95 - 2017</a></h2>
                            <div class="product-sidebar-price">
                                <ins>&#8377;700.00</ins> <del>&#8377;800.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="image/ipad-2.jpg" class="recent-thumb" alt="">
                            <h2><a href="#">Samsung  - 2016</a></h2>
                            <div class="product-sidebar-price">
                                <ins>&#8377;700.00</ins> <del>&#8377;800.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="image/ipad-3.jpg" class="recent-thumb" alt="">
                        ...
                        <div class="thubmnail-recent">
                            <img src="image/ipad-4.png" class="recent-thumb" alt="">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <img src="image/ipad-1.jpg" alt="">
                                    </div>
                                    
                                    <div class="product-gallery">
                                        <img src="image/ipad-2.jpg" alt="">
                                        <img src="image/ipad-3.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name d1"data_value="Samsung Ipad - 2015">Samsung Ipad - 2015</h2>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="profile">
                                                <h2>Reviews</h2>
                                                <form action="ipad-review.php" method="post">
                                                <div class="submit-review">
                                                    <p><label for="name">Name</label> <input name="name3" type="text" required="required"></p>
                                                    <p><label for="email">Email</label> <input name="email3" type="email" required="required"></p>
                                                    <div class="rating-chooser">
                                                        <p>Your rating</p>
                                                        <div class="rating-wrap-post rating">
                                                            
                                                            <input type="radio" id="star5" name="rating3" value="5" required="required" /><label class = "full" for="star5" title="Awesome - 5 stars"></label>
    <input type="radio" id="star4" name="rating3" value="4" required="required" /><label class = "full" for="star4" title="Pretty good - 4 stars"></label>
    <input type="radio" id="star3" name="rating3" value="3" required="required" /><label class = "full" for="star3" title="Meh - 3 stars"></label>
    <input type="radio" id="star2" name="rating3" value="2" required="required" /><label class = "full" for="star2" title="Kinda bad - 2 stars"></label>
    <input type="radio" id="star1" name="rating3" value="1" required="required" /><label class = "full" for="star1" title="Sucks big time - 1 star"></label>
                                                        
                                                        </div>
                                                    </div>
                                                    <p><label for="review"></label> <textarea name="review3" required="required" placeholder="Your review" id="" cols="30" rows="10"></textarea></p>
