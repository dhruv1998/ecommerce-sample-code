...
<div id="myFormRagister" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <tr>
        ...
        <form action="cartitem3.php" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="laptop-product.php"class="cart-detail d1"data_value="2006">Hp Laptops - 2017</a></h2>
                            <script type="text/javascript">
                ...
                ?>
                 <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="laptop-product.php"class="cart-detail d2" data_value="2007">Dell Laptops  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <?php
             ...
             <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="laptop-product.php"class="cart-detail d3" data_value="2008">Apple Laptops  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="laptop-product.php" class="cart-detail d4"data_value="2009">Lenovo Inspire - 2018</a></h2>
                            <script type="text/javascript">
