...
<div id="myFormRagister" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <tr>
        ...
        <form action="cartitem4.php" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="ipad-product.php"class="cart-detail d1" data_value="2010">Dell Ipad - 2017</a></h2>
                            <script type="text/javascript">
                ...
                ?>
                 <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="ipad-product.php"class="cart-detail d2" data_value="2011">Asus Ipads  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <?php
             ...
             <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="ipad-product.php"class="cart-detail d3"data_value="2012">Samsung Ipad  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="ipad-product.php" class="cart-detail d4"data_value="2013">Lenovo Inspire Ipad - 2017</a></h2>
                            <script type="text/javascript">
