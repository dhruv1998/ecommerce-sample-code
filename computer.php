...
<div id="myFormRagister" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <tr>
        ...
        <form action="cartitem2.php" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="computer-product.php"class="cart-detail d1" data_value="2002">Hp Computers - 2017</a></h2>
                            <script type="text/javascript">
                ...
                ?>
                 ...
                 <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="computer-product.php"class="cart-detail d2" data_value="2003">Dell V9  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <?php
             ...
             <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="computer-product.php"class="cart-detail d3" data_value="2004">Apple Computers  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <div class="col-md-3">
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="image/computer-4.jpg" alt="">
                                    <div class="product-hover">
                                        <form action="cart2.php" method="post">
                                            <input type="hidden" name="code" value="">
                            ...
                            <h2><a href="computer-product.php" class="cart-detail d4" data_value="2005">Lenovo Inspiration  - 2017</a></h2>
                             <script type="text/javascript">
