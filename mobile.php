...
<div id="myFormRagister" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <tr>
        ...
        <form action="cartitem1.php" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="mobile-product.php"class="cart-detail d1" data_value="1998">Iphone X Modal - 2017</a></h2>
                            <script type="text/javascript">
                ...
                ?>
                 <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="mobile-product.php"class="cart-detail d2"data_value="1995">Samsung Galaxy  - 2017</a></h2>
                            <script type="text/javascript">
            ...
            <?php
             ...
             <div class="col-md-3">
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="image/mobile-2.jpg" alt="">
                                    <div class="product-hover">
                                        <form action="cart1.php" method="post">
                                            <input type="hidden" name="code" value="">
                            ...
                            <h2><a href="mobile-product.php"class="cart-detail d3" data_value="2000">Motorola RAZAR V8  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <div class="col-md-3">
                        <div class="product-carousel">
                            ...
                            <h2><a href="mobile-product.php" class="cart-detail d4"data_value="2001">Lava X3  - 2017</a></h2>
                            <script type="text/javascript">
