...
<div id="myFormRagister" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="user-ragister.php" method="post" style="max-width:500px;margin:auto">
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="text" placeholder="Username" name="uname1">
  </div>
  ...
  <div class="input-container">
    <i class="fa fa-key icon"></i>
    <input class="input-field" type="password" placeholder="Password" name="psw1">
  </div>

   <div class="input-container">
    <i class="fa fa-key icon"></i>
    <input class="input-field" type="password" placeholder="Confirm Password" name="psw2">
  </div>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#">e<span>Basket</span></a></h1>
                    </div>
                </div>
                            ...
                            <div class="slide-text">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                <h2> Thank you for being an important part of our company. </h2>
                            ...
                            <div class="slide-text">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                <h2>We are providing top brand</h2>
     ...
     <div class="maincontent-area">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                $sql = 'SELECT * FROM laptop WHERE laptop.username="'.$_SESSION['user'].'"';
                $query = mysqli_query($conn,$sql);
                if(!$query) {
                    die('Sql Error: '.mysqli_error($conn));
                }
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <button class="add-to-cart-link btna btna1"><i class="fa fa-shopping-cart"></i> Add to cart</button>
                                    </form>
                                        <a href="laptop-product.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            </div>
                            <h2><a href="laptop-product.php"class="cart-detail d1" data_value="1997">Dell Inspiration Design - 2015</a></h2>
                            <script type="text/javascript">
                ...
                $sql = 'SELECT * FROM mobile WHERE mobile.username="'.$_SESSION['user'].'"';
                $query = mysqli_query($conn,$sql);
                if(!$query) {
                    die('Sql Error: '.mysqli_error($conn));
                }
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <form action="cart.php" method="post">
                                        <input type="hidden" name="code" value="">
                                        <button class="add-to-cart-link btna btna2"><i class="fa fa-shopping-cart"></i> Add to cart</button>
                                    </form>
                                        <a href="mobile-product.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            </div>
                            <h2><a href="mobile-product.php"class="cart-detail d2" data_value="1998">Apple  - 2017</a></h2>
                            <script type="text/javascript">
            ...
            <?php
                ...
                $sql = 'SELECT * FROM ipad WHERE ipad.username="'.$_SESSION['user'].'"';
                $query = mysqli_query($conn,$sql);
                if(!$query) {
                    die('Sql Error: '.mysqli_error($conn));
                }
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <a href="ipad-product.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            </div>
                            <h2><a href="ipad-product.php"class="cart-detail d3"data_value="1996">Ipad Pro  - 2018</a></h2>
                            <script type="text/javascript">
            ...
            <?php
                ...
                $sql = 'SELECT * FROM computer WHERE computer.username="'.$_SESSION['user'].'"';
                $query = mysqli_query($conn,$sql);
                if(!$query) {
                    die('Sql Error: '.mysqli_error($conn));
                }
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <a href="computer-product.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            </div>
                            <h2><a href="computer-product.php" class="cart-detail d4" data_value="1999">Apple computer -2017</a></h2>
                            <script type="text/javascript">
