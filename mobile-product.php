  ...
  <div class="modal-dialog">
   ...
   <!-- <script type="text/javascript">
                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="image/product-7.jpg" class="recent-thumb" alt="">
                            <h2><a href="#">Samsung Galaxy Note 3 - 2017</a></h2>
                            <div class="product-sidebar-price">
                                <ins>&#8377;700.00</ins> <del>&#8377;800.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="image/product-8.jpg" class="recent-thumb" alt="">
                            <h2><a href="#">Samsung Note 3 - 2016</a></h2>
                            <div class="product-sidebar-price">
                                <ins>&#8377;700.00</ins> <del>&#8377;800.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="image/mobile-1.png" class="recent-thumb" alt="">
                            <h2><a href="">Lg S5 - 2018</a></h2>
                            <div class="product-sidebar-price">
                                <ins>&#8377;700.00</ins> <del>&#8377;800.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="image/mobile-3.jpg" class="recent-thumb" alt="">
                            <h2><a href="">Lenovo S6 - 2014</a></h2>
                            <div class="product-sidebar-price">
                                <ins>&#8377;700.00</ins> <del>&#8377;800.00</del>
                            </div>                             
                        </div>
                    ...
                    <div class="single-sidebar">
                        ...
                        <ul>
                            <li><a href="#">Samsung Galaxy V8 - 2018</a></li>
                            <li><a href="#">Samsung Galaxy V8 - 2018</a></li>
                            <li><a href="#">Samsung Galaxy V8 - 2018</a></li>
                            <li><a href="#">Samsung Galaxy V8 - 2018</a></li>
                            <li><a href="#">Samsung Galaxy V8 - 2018</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    ...
                                    <div class="product-gallery">
                                        <img src="image/mobile-1.png" alt="">
                                        <img src="image/mobile-3.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name d1"data_value="1994">Iphone XS - 2018</h2>
                                    <div class="product-inner-price">
                                        <ins class="price d3" data_value="700">&#8377;700.00</ins> <del>&#8377;800.00</del>
                                    </div>  
                                    <script type="text/javascript">
                                     $(document).ready(function(){
                                var code = $(".d1").attr("data_value");
                                var quantity = $('.qty').val();
                                var price = $(".d3").attr("data_value");
                                $(".btna1").click(function() {
                                    $(this).prev('#code').val(code);
                                    $(this).prev('#quantity').val(quantity);
                                    $(this).prev('#price').val(price);
                                });
                                });
                            </script>  
                                    ...
                                    <form action="quantity.php" method="post">
                                     ...
                                     <button class="add_to_cart_button btna1" onclick="addcard();">Add to cart</button>
                                 </form>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="profile">
                                                <h2>Reviews</h2>
                                                <form action="mobile-review.php" method="post">
    ...
    <input type="radio" id="star1" name="rating" value="1" required="required" /><label class = "full" for="star1" title="Sucks big time - 1 star"></label>
                                                    ...
                                                    <p><label for="review"></label> <textarea name="review" required="required" placeholder="Your Review" id="" cols="30" rows="10"></textarea></p>
                                                    <p><input type="submit" name="submit" value="submit2"></p>
                                                </form>
                                                </div>
                                                </div>
                                            </div>
